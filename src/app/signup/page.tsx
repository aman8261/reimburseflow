...
import { Briefcase, CheckCircle2, Circle, FlaskConical } from 'lucide-react';
        ...
        {[
          ...
          <div key={item.key} style={{
            ...
            <span style={{ display: 'flex' }}>
              {checks[item.key as keyof typeof checks] ? <CheckCircle2 size={12} /> : <Circle size={12} />}
            </span>
            {item.label}
          </div>
        ))}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label className="form-label" style={{ display: 'flex', alignItems: 'center' }}>
                Email Address
                {emailStep === 'verified' && (
                  <span style={{ color: '#2ecc71', fontWeight: 600, marginLeft: 8, fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px' }}><CheckCircle2 size={14} /> Verified</span>
                )}
              </label>
              ...
              {emailStep === 'otp-sent' && (
                <div style={{
                  ...
                  {previewUrl && (
                    <p style={{ fontSize: '0.6875rem', color: '#714b67', marginTop: 8, display: 'flex', alignItems: 'center', gap: '4px' }}>
                      <FlaskConical size={14} /> Dev mode: <a href={previewUrl} target="_blank" rel="noopener" style={{ color: '#714b67', textDecoration: 'underline' }}>View email in browser</a>
                    </p>
                  )}
                </div>
              )}
            ...
            <div className="form-group">
              ...
              {form.confirmPassword && form.password === form.confirmPassword && form.confirmPassword.length > 0 && (
                <span style={{ display: 'flex', alignItems: 'center', gap: '4px', marginTop: 4, fontSize: '0.8125rem', color: '#2ecc71' }}><CheckCircle2 size={14} /> Passwords match</span>
              )}
            </div>
