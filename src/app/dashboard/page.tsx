...
import { ClipboardList, Hourglass, CheckCircle2, XCircle, Wallet } from 'lucide-react';
    ...
    <div>
      ...
      <div className="stats-grid">
        <div className="stat-card">
          <div className="stat-icon" style={{ background: '#f5f0f4', color: '#714b67' }}><ClipboardList size={24} /></div>
          <div className="stat-value">{stats.total}</div>
          <div className="stat-label">Total Expenses</div>
        </div>
        <div className="stat-card">
          <div className="stat-icon" style={{ background: '#fef5e7', color: '#f39c12' }}><Hourglass size={24} /></div>
          <div className="stat-value">{stats.pending}</div>
          <div className="stat-label">Pending Approval</div>
        </div>
        <div className="stat-card">
          <div className="stat-icon" style={{ background: '#e8f8f0', color: '#2ecc71' }}><CheckCircle2 size={24} /></div>
          <div className="stat-value">{stats.approved}</div>
          <div className="stat-label">Approved</div>
        </div>
        <div className="stat-card">
          <div className="stat-icon" style={{ background: '#fdeaea', color: '#e74c3c' }}><XCircle size={24} /></div>
        ...
        <div className="card-body" style={{ padding: 0 }}>
          {recentExpenses.length === 0 ? (
            <div className="empty-state">
              <div className="empty-icon" style={{ display: 'flex', justifyContent: 'center' }}><Wallet size={48} /></div>
