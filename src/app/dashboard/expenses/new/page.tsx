      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 24 }}>
        ...
        <div className="card" style={{ alignSelf: 'start' }}>
          <div className="card-header" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <Camera size={20} />
            <h3 style={{ fontSize: '0.9375rem', fontWeight: 600, margin: 0 }}>Scan Receipt (OCR)</h3>
          </div>
            ...
            <div style={{
              ...
              <label htmlFor="ocr-input" style={{ cursor: 'pointer' }}>
                {ocrProcessing ? (
                  ...
                  <>
                    <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 8, color: '#9ca3af' }}><ImageIcon size={48} /></div>
