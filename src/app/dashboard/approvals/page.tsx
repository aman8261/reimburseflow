        ...
        <div className="card-body" style={{ padding: 0 }}>
          {loading ? (
            ...
            <div className="empty-state">
              <div className="empty-icon" style={{ display: 'flex', justifyContent: 'center', color: '#2ecc71' }}><CheckCircle2 size={48} /></div>
              <h3>All caught up!</h3>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                {actionModal.action === 'APPROVE' ? <CheckCircle size={24} color="#2ecc71" /> : <XCircle size={24} color="#e74c3c" />}
