...
import { Briefcase, Zap, Globe, Camera, Key, Mail, AlertTriangle, FlaskConical } from 'lucide-react';
    ...
    <div style={styles.container}>
      <div style={styles.left}>
        <div style={styles.branding}>
          <div style={styles.logo}><Briefcase size={48} strokeWidth={1.5} /></div>
          ...
          <div style={styles.features}>
            <div style={styles.feature}>
              <span style={styles.featureIcon}><Zap size={24} /></span>
              <div>
            ...
            <div style={styles.feature}>
              <span style={styles.featureIcon}><Globe size={24} /></span>
              <div>
            ...
            <div style={styles.feature}>
              <span style={styles.featureIcon}><Camera size={24} /></span>
              <div>
        ...
        <div className="modal-overlay" onClick={() => setShowForgot(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Key size={24} /> Reset Your Password</h2>
            ...
            <div className="modal-body">
              {!forgotSuccess ? (
                ...
                <div style={{ textAlign: 'center', padding: '16px 0' }}>
                  <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'center', color: '#714b67' }}><Mail size={48} /></div>
                  ...
                  <p style={{ color: '#e67e22', fontSize: '0.8125rem', fontWeight: 500, marginBottom: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                    <AlertTriangle size={16} /> Please change your password after logging in via Dashboard → Settings.
                  </p>
                  {forgotPreviewUrl && (
                    <p style={{ fontSize: '0.75rem', color: '#714b67', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
